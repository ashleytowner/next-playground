...
export default function NavBar() {
	return (
		<nav className="md:top-0 md:sticky bg-material-50 pl-4 dark:bg-material-900 flex flex-row whitespace-nowrap overflow-x-auto gap-3 shadow-material-400 dark:shadow-material-950 shadow">
