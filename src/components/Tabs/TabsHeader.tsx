...
export default function TabsHeader(props: TabsHeaderProps) {
	return (
		<div className={`${props.className || ''} bg-slate-200 dark:bg-slate-900 p-1 rounded border-slate-300 dark:border-slate-600 border-2 inline-flex gap-3 justify-between`}>
